const Hero = () => {
    return (
        <section className="flex flex-row p-4">
            <div className="p-12">
                <h1 className="text-largest font-extrabold">Hi, I'm Prabhat Kumar!</h1>
                <h2 className="text-large font-light p-2">A Passionate Web Developer</h2>
            ...
            <div className="">
                <img src="./images/profile-picture.png" alt="Prabhat Kumar's Profile Picture" className="w-[100%] rounded-[50%]" />
            </div>
        </section>
    );
}
