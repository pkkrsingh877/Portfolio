        ...
        <section className="flex flex-col p-4" id="skills">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-row justify-between items-center w-full">
                    ...
                    <input id="disabled-range" type="range" value="98" className="w-[50%] h-2 bg-accent rounded-lg appearance-none cursor-pointer" disabled />
                </div>
                <div className="flex flex-row justify-between items-center w-full">
                    <h3 className="text-medium font-normal px-4">CSS</h3>
                    <input id="disabled-range" type="range" value="80" className="w-[50%] h-2 bg-accent rounded-lg appearance-none cursor-pointer" disabled />
                </div>
                <div className="flex flex-row justify-between items-center w-full">
                    <h3 className="text-medium font-normal px-4">JavaScript</h3>
                    <input id="disabled-range" type="range" value="90" className="w-[50%] h-2 bg-accent rounded-lg appearance-none cursor-pointer" disabled />
                </div>
                <div className="flex flex-row justify-between items-center w-full">
                    <h3 className="text-medium font-normal px-4">React.js</h3>
                    <input id="disabled-range" type="range" value="75" className="w-[50%] h-2 bg-accent rounded-lg appearance-none cursor-pointer" disabled />
                </div>
                <div className="flex flex-row justify-between items-center w-full">
                    <h3 className="text-medium font-normal px-4">Vue.js</h3>
                    <input id="disabled-range" type="range" value="50" className="w-[50%] h-2 bg-accent rounded-lg appearance-none cursor-pointer" disabled />
                </div>
                <div className="flex flex-row justify-between items-center w-full">
                    <h3 className="text-medium font-normal px-4">Node.js</h3>
                    <input id="disabled-range" type="range" value="85" className="w-[50%] h-2 bg-accent rounded-lg appearance-none cursor-pointer" disabled />
                </div>
                <div className="flex flex-row justify-between items-center w-full">
                ...
                <div className="flex flex-row justify-between items-center w-full">
                    ...
                    <input id="disabled-range" type="range" value="70" className="w-[50%] h-2 bg-accent rounded-lg appearance-none cursor-pointer" disabled />
                </div>
                <div className="flex flex-row justify-between items-center w-full">
